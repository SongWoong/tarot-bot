...
⬅️ 첫 번째 카드 — {card0}
(이 카드의 의미를 Yes/No 관점에서 10문장으로 해석)
...
⬅️ 현재 감정 — {card0}
(상대방 또는 본인의 현재 감정 상태를 10~11문장으로 해석)

🔮 관계의 흐름 — {card1}
(두 사람 사이의 현재 에너지와 흐름을 10~11문장으로 해석)

➡️ 앞으로의 가능성 — {card2}
(재회 또는 새로운 사랑의 가능성을 10~11문장으로 해석)

✨ 종합 메시지
(연애운 전체를 종합한 따뜻한 조언을 15문장으로)"""
    },
    "career": {
...
⬅️ 현재 상황 — {card0}
(직장 또는 금전 관련 현재 상황을 10~11문장으로 해석)
